...
export class TemplateOneComponent implements OnInit {
  ...
  private openChat(iframe: HTMLElement): void {
    // Assuming there's a method to open the chat; replace with actual logic
    // Example: iframe.contentWindow?.postMessage('open', '*'); 
    console.log('Opening chat box...'); // Placeholder for chat opening logic
  }
}
